...
CONFIG.NUM_PORTS {2} \
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins s_axi_CONTROL_BUS] [get_bd_intf_pins image_filter_0/s_axi_CONTROL_BUS]
...
CONFIG.VCCDDRO_ALARM_LOWER.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net AXI_INTC0_M06_AXI [get_bd_intf_pins AXI_INTC0/M06_AXI] [get_bd_intf_pins video/s_axi_CONTROL_BUS]
